...
from app.features.notifications.schemas import NotificationResponse, NotificationUnreadCountResponse
...
async def list_notifications(
    ...
    notifs, _ = await service.list_user_notifications(str(current_user.id), unread_only, page, per_page)
    return notifs
